...
echo -e "    flatpak install flathub com.brave.Browser"
echo -e "    flatpak install flathub io.gitlab.librewolf-community"
echo -e "    flatpak install flathub org.chromium.Chromium"
echo ""
